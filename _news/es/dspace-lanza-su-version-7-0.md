...
title: DSpace lanza su versión 7.0
...
**DSpace 7.0 ha sido desarrollado por la colaboración de más de 60 desarrolladores de la comunidad, liderados por LYRASIS, Atmire y 4Science. Más de 25 instituciones de todo el mundo han aportado generosamente su apoyo financiero.** Consulte la lista completa de colaboradores en las [las notas de la versión](https://wiki.lyrasis.org/display/DSDOC7x/Release+Notes).notas de la versión. Si desea contribuir a la próxima versión 7.x, considere la posibilidad de unirse a futuras reuniones del [Grupo de Trabajo de DSpace 7](https://wiki.lyrasis.org/display/DSPACE/DSpace+7+Working+Group).

**Características de DSpace**

[La versión 7.0 de DSpace](https://duraspace.org/dspace/download/) incluye las siguientes características:

...
Invest in Open Infrastructure (IOI) anunció que[LA Referencia](https://www.lareferencia.info/en/?ref=investinopen.org)es uno de los ganadores inaugurales del[Fondo IOI para la Adopción de la Red](https://investinopen.org/funding-pilots/ioi-fund/). Fue seleccionada de entre más de 100 postulaciones de 22 países, y, de acuerdo a IOI "la propuesta fue ambiciosa, disruptiva y ofrece soluciones localizadas a los desafíos en el ecosistema de la investigación abierta en Latinoamérica".

LA Referencia recibirá fondos por USD 1.500.000 en los próximos dos a tres años para avanzar en la adopción de la infraestructura abierta y fortalecer los ecosistemas de investigación regionales. Además del financiamiento, el personal de IOI brindará apoyo continuo a los equipos de proyecto durante la implementación para respaldar y mejorar su gobernanza, compromiso con la comunidad, modelos financieros y de negocios, asegurando la resiliencia y el impacto de estas redes a largo plazo.

**El proyecto ganador**
-----------------------

[LA Referencia](https://www.lareferencia.info/en/?ref=investinopen.org)expandirá y mejorará su plataforma de investigación compartida en toda Latinoamérica de manera tal que el trabajo científico de la región se pueda compartir, preservar y descubrir más fácilmente a nivel global. LA Referencia opera una plataforma de descubrimiento y agregado regional que actualmente conecta a 10 países y que recolecta y preserva información investigativa de repositorios nacionales en cada país miembro. Los elementos clave de este proyecto propuesto incluyen:
...
*   Mejorar la plataforma con capacidades nuevas, incluyendo:
    ...
    *   Implementar un sistema identificador persistente y descentralizado (dARK) – basado en la tecnología _blockchain_ y que ya funciona en IBICT (Brasil) – para asegurar que los resultados de las investigaciones y los metadatos continúen siendo accesibles de manera permanente y verificable, incluso en caso de que se presenten fallas locales en el sistema.
...
Respaldados por la generosa colaboración de[Wellcome](https://wellcome.org/?ref=investinopen.org),[Digital Science](https://www.digital-science.com/?ref=investinopen.org), la Fundación Kahle Austin, la Fundación Karger Publishers,[Arcadia](https://arcadiafund.org.uk/?ref=investinopen.org),[EBSCO](https://www.ebsco.com/?ref=investinopen.org), y demás donantes privados, el Fondo apunta a acelerar la adopción global de los datos abiertos y las infraestructuras para compartir conocimiento, permitiendo una investigación más igualitaria y colaborativa en todo el mundo.

*Artículo basado en la información publicada por Invest In Open Infrastructure

...
title: 'Estamos contratando: Programador/a JAVA - DSpace - Proyecto de Fortalecimiento
  de Repositorios de Acceso Abierto en América Latina (LA Referencia / Lyrasis)'
...
Los/as interesados/as deben enviar su CV y una carta de presentación que destaque su experiencia relevante, enlaces a repositorios de código (GitHub, GitLab, etc.) o ejemplos de contribuciones a DSpace a la dirección de correo electrónico [](mailto:lareferencia@lareferencia.redclara.net)[lareferencia@lareferencia.redclara.net](mailto:lareferencia@lareferencia.redclara.net).Por favor, utilizar el asunto: "Postulación para Programador/a DSpace".

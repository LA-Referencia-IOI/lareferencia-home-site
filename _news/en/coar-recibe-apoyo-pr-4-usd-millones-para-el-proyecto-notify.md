...
**COAR obtained a $4 million grant from Arcadia,** a fund from Lisbet Rausing and Peter Baldwin. **The 4-year funding will go to the [Notify project,](https://www.coar-repositories.org/notify/)** which is developing and implementing a standard protocol to connect content in the distributed network of repositories with peer reviews and evaluations in external services, using linked data notifications.

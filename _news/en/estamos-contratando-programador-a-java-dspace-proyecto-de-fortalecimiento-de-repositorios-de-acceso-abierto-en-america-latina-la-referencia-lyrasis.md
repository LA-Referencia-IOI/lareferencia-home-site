...
Interested applicants should send their CV and a cover letter highlighting their relevant experience, links to code repositories (GitHub, GitLab, etc.) or examples of contributions to DSpace to the email address [](mailto:larereference@larereference.redclara.net)[larereference@larereference.redclara.net](mailto:larereference@larereference.redclara.net).Please use the subject: "Application for DSpace Programmer".

...
Three years ago, a group of editors developed, facilitated by the [FAIRsharing](https://fairsharing.org/) initiative, the so-called “[Selection criteria for data repositories that matter](https://osf.io/m2bce/)”, a set of aspects that they consider should be taken into account for the identification and selection of data repositories. Given this, COAR, CoreTrustSeal, European University Association, Science Europe, and World Data System, have pointed out that these criteria, as they are currently conceived, will act as an impediment to achieving the objectives that really matter. LA Reference together with other organizations have signed in support of this initiative.
...
* They threaten the exclusion of many repositories, limiting the options for researchers.
*Does not build on existing best practice frameworks for data repositories.
...
[Read the full joint position here.](https://zenodo.org/record/4649136#.YGs4NBQVATV)

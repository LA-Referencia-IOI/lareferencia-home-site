...
Invest in Open Infrastructure (IOI) announced that [THE Reference](https://www.lareferencia.info/en/?ref=investinopen.org) is one of the inaugural winners of the[IOI Network Adoption Fund](https://investinopen.org/funding-pilots/ioi-fund/). It was selected from more than 100 applications from 22 countries, and, according to IOI "the proposal was ambitious, disruptive and offers localized solutions to the challenges in the open research ecosystem in Latin America."
...
* Enhance the platform with new capabilities, including:
    ...
    * Implement a persistent and decentralized identifier system (dARK) – based on _blockchain_ technology and already operating at IBICT (Brazil) – to ensure that research results and metadata continue to be accessible in a permanent and verifiable manner, even in the event of local failures in the system.
...
Supported by the generous collaboration of [Wellcome](https://wellcome.org/?ref=investinopen.org), [Digital Science](https://www.digital-science.com/?ref=investinopen.org), the Kahle Austin Foundation, the Karger Publishers Foundation, [Arcadia](https://arcadiafund.org.uk/?ref=investinopen.org), [EBSCO](https://www.ebsco.com/?ref=investinopen.org), and other private donors, the Fund aims to accelerate the global adoption of open data and knowledge-sharing infrastructures, enabling more equitable research and collaborative around the world.

...
* The agreement was signed by the [Spanish Foundation for Science and Technology (FECYT)](https://www.fecyt.es/), a public foundation dependent on the [Ministry of Science and Innovation](https://www.ciencia.gob.es/portal/site/MICINN/) of the European country.

* Since 2007, FECYT, together with the [University Library Network (REBIUN)](https://www.rebiun.org/) of the [Conference of Rectors of Spanish Universities (CRUE)](https://www.crue.org/), manages [RECOLECTA](https://www.recolecta.fecyt.es/portada?language=es), the national aggregator of open access repositories in Spain.

This Wednesday, October 21, **Spain joined as a new member of LA Reference**, the Latin American network that has associated countries working for Open Science. The accession agreement was signed through a virtual conference by Cecilia Cabello, director of the Spanish Foundation for Science and Technology (FECYT), Bianca Amaro, president of LA Reference and Luis Eliécer Cadenas, executive director of [RedCLARA](https://redclara.net/index.php/es/).

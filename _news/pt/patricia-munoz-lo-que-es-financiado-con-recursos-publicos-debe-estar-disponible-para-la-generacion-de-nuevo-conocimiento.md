...
De acordo com o [documento escrito da Política](https://s3.amazonaws.com/documentos.anid.cl/estudios/Politica_acceso_a_informacion_cientifica_version_final_26-05-2020.pdf), ela é definida em duas fases:

· Primeira Fase: **segue o modelo [Rota Verde](https://universoabierto.org/2019/03/13/las-5-rutas-para-llegar-al-acceso-abierto-verde-dorada-bronce-hibrida-y-diamante/).** Os dados respondem aos princípios FAIR (em inglês: Findability, Accessibility, Interoperability and Resusability), ou seja: Findable, Accessible, Interoperable e Reusable. O objetivo é compilar, no prazo de dois anos, a informação de base necessária sobre a utilização da informação e dos dados, os custos associados à sua gestão e as despesas incorridas pelos investigadores na publicação.

· Segunda fase: **neste momento procuraremos implementar a[Rota Dourada](https://www.sedic.es/autoformacion/acceso_abierto/2-vias-acceso-abierto.html),** onde os períodos de embargo da Rota Verde seriam eliminados e as publicações seriam disponibilizadas em acesso aberto imediatamente.
...
[**Aqui você encontra o resumo da entrevista realizada**](https://youtu.be/D0CFgV7w2a8)
